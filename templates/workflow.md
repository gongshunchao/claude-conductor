...
> Default workflow template for Conductor-managed projects.
> Customize this file during `/conductor:setup` to match your project's needs.
...
|---------|---------|---------|
| Coverage Target | 80% | 70%, 80%, 90%, 100% |
